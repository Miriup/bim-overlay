...
COMMON_DEPEND="
	...
	qt5? (
	=dev-python/pyside-9999[svg,${PYTHON_USEDEP}]
	=dev-python/shiboken-9999[${PYTHON_USEDEP}]
	dev-qt/designer:5
	dev-qt/qtgui:5[-egl]
	dev-qt/qtopengl:5
	dev-qt/qtsvg:5
...
DEPEND="${COMMON_DEPEND}
	...
	qt5? (
		=dev-python/pyside-tools-9999[${PYTHON_USEDEP}]
	)"
...
src_configure() {
	use qt5 && QT_SELECT=5 || QT_SELECT=4
	export QT_SELECT
	...
	local mycmakeargs=(
		...
		-DCMAKE_INSTALL_DATADIR="${EPREFIX}/usr/share/${P}"
		-DCMAKE_INSTALL_DOCDIR="${EPREFIX}/usr/share/doc/${PF}"
		-DCMAKE_INSTALL_INCLUDEDIR="${EPREFIX}/usr/include/${P}"
